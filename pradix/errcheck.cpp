...
*******************************************************************************/
// Modified by Geoff McQueen 2/6/2018
#include <stdlib.h>
#include <stdio.h>
...
void CheckVslError(int num)
{
    switch(num) {
        ...
        case VSL_RNG_ERROR_ARS5_NOT_SUPPORTED: {
            printf("Error: ARS-5 random number generator is not supported on the CPU which runs the application (code %d).\n",num);
            break;
        }
        ...
        case VSL_SS_ERROR_BAD_SUM_ADDR: {
            printf("Error: array of sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_2R_SUM_ADDR: {
            printf("Error: array of 2nd order raw sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_3R_SUM_ADDR: {
            printf("Error: array of 3d order raw sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_4R_SUM_ADDR: {
            printf("Error: array of 4th order raw sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_2C_SUM_ADDR: {
            printf("Error: array of 2nd order central sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_3C_SUM_ADDR: {
            printf("Error: array of 3d order central sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_4C_SUM_ADDR: {
            printf("Error: array of 4th order central sums is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_CP_ADDR: {
            printf("Error: cross-product matrix is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_MDAD_ADDR: {
            printf("Error: array of median absoltute deviations is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_MNAD_ADDR: {
            printf("Error: array of mean absolute deviations is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_BAD_SORTED_OBSERV_ADDR: {
            printf("Error: array for sorting is not defined (code %d).\n",num);
            break;
        }
        case VSL_SS_ERROR_INDICES_NOT_SUPPORTED: {
            printf("Error: array of indices is not supported with in-place sorting (code %d).\n",num);
            break;
        }
    }
